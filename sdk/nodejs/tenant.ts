...
export class Tenant extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'frontegg:index/tenant:Tenant';
     ...
     */
    public readonly applicationUri!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: TenantArgs | TenantState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["applicationUri"] = state ? state.applicationUri : undefined;
            resourceInputs["key"] = state ? state.key : undefined;
            resourceInputs["name"] = state ? state.name : undefined;
        } else {
            const args = argsOrState as TenantArgs | undefined;
            if ((!args || args.applicationUri === undefined) && !opts.urn) {
                throw new Error("Missing required property 'applicationUri'");
            }
            if ((!args || args.key === undefined) && !opts.urn) {
                throw new Error("Missing required property 'key'");
            }
            resourceInputs["applicationUri"] = args ? args.applicationUri : undefined;
...
export interface TenantState {
     ...
     * The application URI for this tenant.
     */
    applicationUri?: pulumi.Input<string>;
    /**
     * A human-readable identifier for the tenant.
     */
