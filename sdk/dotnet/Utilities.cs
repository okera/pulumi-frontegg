...
namespace Pulumi.Frontegg
{
    static class Utilities
    {
        ...
        public static InvokeOptions WithDefaults(this InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/okera/pulumi-frontegg/releases/";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Frontegg.version.txt");
    ...
    internal sealed class FronteggResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public FronteggResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
