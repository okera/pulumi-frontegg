...
import (
	...
	"github.com/okera/pulumi-frontegg/provider/pkg/version"
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		License:    "Apache-2.0",
		Homepage:   "https://www.frontegg.com",
		Repository: "https://github.com/okera/pulumi-frontegg",
		...
		JavaScript: &tfbridge.JavaScriptInfo{
			PackageName: "@okera/pulumi-frontegg",
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: filepath.Join(
				fmt.Sprintf("github.com/okera/pulumi-%[1]s/sdk/", mainPkg),
